...
# ---------- Load your NU Pokemon ----------
with open("mons_NU.json", "r", encoding="utf-8") as f:
    nu_data = json.load(f)

pokemon_list = nu_data["NU"]["pokemon"]
...
# ---------- Save result ----------
with open("nu_with_moves.json", "w", encoding="utf-8") as f:
    json.dump(nu_data, f, indent=2)

print("Done! Saved to nu_with_moves.json")
