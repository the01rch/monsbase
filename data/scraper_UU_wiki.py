...
# ---------- Load your UU Pokemon ----------
with open("mons_UU.json", "r", encoding="utf-8") as f:
    uu_data = json.load(f)

pokemon_list = uu_data["UU"]["pokemon"]
...
# ---------- Save result ----------
with open("uu_with_moves.json", "w", encoding="utf-8") as f:
    json.dump(uu_data, f, indent=2)

print("Done! Saved to uu_with_moves.json")
