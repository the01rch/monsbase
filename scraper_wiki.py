...
# ---------- Load your OU Pokemon ----------
with open("mons_OU.json", "r", encoding="utf-8") as f:
    ou_data = json.load(f)

pokemon_list = ou_data["tiers"]["OU"]["pokemon"]
...
# ---------- Save result ----------
with open("ou_with_moves.json", "w", encoding="utf-8") as f:
    json.dump(ou_data, f, indent=2)

print("Done! Saved to ou_with_moves.json")
